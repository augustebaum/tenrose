...
2. QuickJS is a lightweight JS runtime; rquickjs is a Rust library to call JS from Rust (among other things).
...
- https://github.com/svg/svgo for an example of rquickjs to wrap around a JS library.
