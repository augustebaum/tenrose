...
This is a bare-bone typst plugin, written in Rust. It uses the [wasm-minimal-protocol](https://crates.io/crates/wasm-minimal-protocol) crate to easily define plugin functions.
